...
array<array<long double, 3>, 4> evolve(const int N, array<long double,N> M, array<array<long double, 3>, 4> X, long double T){

}

//Evolution of binary through integration
tuple<array<>, long double> singleTimestep(int N, np.ndarray[double, ndim=2] X, np.ndarray[double, ndim=1] m, int n=1, double dt_max=-1.0, double eta=0.02):
        # dt is step size
        # X = [x1, x2, x3,..., v1, v2, v3,...]
